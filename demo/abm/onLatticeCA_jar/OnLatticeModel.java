...
// ------------------------------------------------------------------------------------------------------------
@CommandLine.Command(name = "2-D Agent Based Model of Drug Addiction",
...
public class OnLatticeModel implements Runnable {
    ...
    @CommandLine.Option(names = { "-initialConditionType", "--initialConditionType"}, description="Seeding architecture (\"random\" or \"circle\")") 
    String initialConditionType = model.initialConditionType;
    ...
    @CommandLine.Option(names = { "-dD_div_S", "--drugEffect_div_S"}, description="Relative amount by which drug reduces division rate of sensitive cells in [0,1].") 
    double drugEffect_div_S = model.drugEffect_div_S;
    @CommandLine.Option(names = { "-dD_div_R", "--drugEffect_div_R"}, description="Relative amount by which drug reduces division rate of resistant cells in [0,1].") 
    double drugEffect_div_R = model.drugEffect_div_R;
